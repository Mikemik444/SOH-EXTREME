...
echo ============================================================
echo SOH-EXTREME 0.7.54 - LOGIC + TRACKER + DEATH-SAFE QUEUE FIX
echo ============================================================
echo.
...
echo APWorld: soh_extreme_0.7.54.apworld
echo 0.7.54 keeps AP items queued until SoH actually grants them and aligns AP/native logic.
