...
void Settings::CreateOptions() {
    ...
    // Mega Randomizer - these are native randomizer settings, not external launcher CVars.
    OPT_BOOL(RSK_SHUFFLE_ROLL, CVAR_RANDOMIZER_SETTING("ShuffleRoll"));
    OPT_BOOL(RSK_SHUFFLE_ENEMY_SOUL, CVAR_RANDOMIZER_SETTING("ShuffleEnemySoul"));
    OPT_BOOL(RSK_SHUFFLE_NPC_SOUL, CVAR_RANDOMIZER_SETTING("ShuffleNpcSoul"));
    OPT_BOOL(RSK_SHUFFLE_ANIMAL_SOUL, CVAR_RANDOMIZER_SETTING("ShuffleAnimalSoul"));
    OPT_BOOL(RSK_SHUFFLE_POT_SOUL, CVAR_RANDOMIZER_SETTING("ShufflePotSoul"));
    OPT_BOOL(RSK_SHUFFLE_CRATE_SOUL, CVAR_RANDOMIZER_SETTING("ShuffleCrateSoul"));
    OPT_BOOL(RSK_SHUFFLE_GRASS_SOUL, CVAR_RANDOMIZER_SETTING("ShuffleGrassSoul"));
    OPT_BOOL(RSK_SHUFFLE_ROCK_SOUL, CVAR_RANDOMIZER_SETTING("ShuffleRockSoul"));
    OPT_BOOL(RSK_SHUFFLE_TREE_SOUL, CVAR_RANDOMIZER_SETTING("ShuffleTreeSoul"));
    OPT_BOOL(RSK_SHUFFLE_BEEHIVE_SOUL, CVAR_RANDOMIZER_SETTING("ShuffleBeehiveSoul"));
    OPT_BOOL(RSK_SHUFFLE_SIGN_SOUL, CVAR_RANDOMIZER_SETTING("ShuffleSignSoul"));
    OPT_BOOL(RSK_SHUFFLE_SKULLTULA_SOUL, CVAR_RANDOMIZER_SETTING("ShuffleSkulltulaSoul"));
    OPT_BOOL(RSK_SHUFFLE_SHOVEL, CVAR_RANDOMIZER_SETTING("ShuffleShovel"));
    OPT_BOOL(RSK_SHUFFLE_BUSINESS_SCRUB_SOUL, CVAR_RANDOMIZER_SETTING("ShuffleBusinessScrubSoul"));
    OPT_BOOL(RSK_NPC_SPEECH_SANITY, CVAR_RANDOMIZER_SETTING("NpcSpeechSanity"));
    OPT_U8(RSK_SONG_NOTE_SHUFFLE, {"Off", "Individual Notes"}, OptionCategory::Setting, CVAR_RANDOMIZER_SETTING("SongNoteShuffle"), WIDGET_CVAR_COMBOBOX, 0);
    OPT_BOOL(RSK_SHUFFLE_FLOW_OF_TIME, CVAR_RANDOMIZER_SETTING("ShuffleFlowOfTime"));
    OPT_U8(RSK_FROZEN_STARTING_TIME, {"Random", "Dawn", "Day", "Dusk", "Night"}, OptionCategory::Setting, CVAR_RANDOMIZER_SETTING("FrozenStartingTime"), WIDGET_CVAR_COMBOBOX, 0);
    OPT_U8(RSK_TIME_SPEED_AFTER_UNLOCK, {"Normal", "2x", "3x", "4x"}, OptionCategory::Setting, CVAR_RANDOMIZER_SETTING("TimeSpeedAfterUnlock"), WIDGET_CVAR_COMBOBOX, 0);
    OPT_U8(RSK_EXTREME_TRAP_POOL, {"Off", "Ice Only", "Expanded"}, OptionCategory::Setting, CVAR_RANDOMIZER_SETTING("ExtremeTrapPool"), WIDGET_CVAR_COMBOBOX, 0);
    OPT_BOOL(RSK_EXTREME_ICE_TRAPS, CVAR_RANDOMIZER_SETTING("ExtremeIceTraps"));
    OPT_BOOL(RSK_EXTREME_FIRE_TRAPS, CVAR_RANDOMIZER_SETTING("ExtremeFireTraps"));
    OPT_BOOL(RSK_EXTREME_SLOW_TRAPS, CVAR_RANDOMIZER_SETTING("ExtremeSlowTraps"));
    OPT_BOOL(RSK_EXTREME_MAGIC_SUCK_TRAPS, CVAR_RANDOMIZER_SETTING("ExtremeMagicSuckTraps"));
    OPT_BOOL(RSK_EXTREME_HEALTH_DRAIN_TRAPS, CVAR_RANDOMIZER_SETTING("ExtremeHealthDrainTraps"));
    OPT_U8(RSK_EXTREME_TRAP_PERCENT, {NumOpts(0, 100)}, OptionCategory::Setting, CVAR_RANDOMIZER_SETTING("ExtremeTrapPercent"), WIDGET_CVAR_SLIDER_INT, 0, true);
    OPT_BOOL(RSK_SHUFFLE_ENEMY_DROPS, CVAR_RANDOMIZER_SETTING("ShuffleEnemyDrops"), IMFLAG_SEPARATOR_BOTTOM, WIDGET_CVAR_CHECKBOX, RO_GENERIC_OFF);
    ...
    mOptionGroups[RSG_MENU_SECTION_ADDITIONAL_ITEMS] = OptionGroup::SubGroup("Additional Items",
                                                                             {
                                                                                 ...
                                                                                 &mOptions[RSK_SHUFFLE_ENEMY_SOUL],
                                                                                 &mOptions[RSK_SHUFFLE_NPC_SOUL],
                                                                                 &mOptions[RSK_SHUFFLE_ANIMAL_SOUL],
                                                                                 &mOptions[RSK_SHUFFLE_POT_SOUL],
                                                                                 &mOptions[RSK_SHUFFLE_CRATE_SOUL],
                                                                                 &mOptions[RSK_SHUFFLE_GRASS_SOUL],
                                                                                 &mOptions[RSK_SHUFFLE_ROCK_SOUL],
                                                                                 &mOptions[RSK_SHUFFLE_TREE_SOUL],
                                                                                 &mOptions[RSK_SHUFFLE_BEEHIVE_SOUL],
                                                                                 &mOptions[RSK_SHUFFLE_SIGN_SOUL],
                                                                                 &mOptions[RSK_SHUFFLE_SKULLTULA_SOUL],
                                                                                 &mOptions[RSK_SHUFFLE_BUSINESS_SCRUB_SOUL],
                                                                                 &mOptions[RSK_SHUFFLE_SHOVEL],
                                                                                 &mOptions[RSK_NPC_SPEECH_SANITY],
                                                                                 &mOptions[RSK_SONG_NOTE_SHUFFLE],
                                                                                 &mOptions[RSK_SHUFFLE_FLOW_OF_TIME],
                                                                                 &mOptions[RSK_FROZEN_STARTING_TIME],
                                                                                 &mOptions[RSK_TIME_SPEED_AFTER_UNLOCK],
                                                                                 &mOptions[RSK_SHUFFLE_ENEMY_DROPS],
    ...
    mOptionGroups[RSG_MENU_SECTION_TRAPS] = OptionGroup::SubGroup("Traps",
                                                                  {
                                                                      ...
                                                                      &mOptions[RSK_EXTREME_TRAP_POOL],
                                                                      &mOptions[RSK_EXTREME_ICE_TRAPS],
                                                                      &mOptions[RSK_EXTREME_FIRE_TRAPS],
                                                                      &mOptions[RSK_EXTREME_SLOW_TRAPS],
                                                                      &mOptions[RSK_EXTREME_MAGIC_SUCK_TRAPS],
                                                                      &mOptions[RSK_EXTREME_HEALTH_DRAIN_TRAPS],
                                                                      &mOptions[RSK_EXTREME_TRAP_PERCENT],
