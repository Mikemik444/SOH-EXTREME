...
static bool MegaIsShovelGrotto(RandomizerRegion region) {
    switch (region) {
        // SOH-EXTREME: Shovel gates every grotto, not only bomb/song/rock-hidden
        // holes.  Include the first internal region for every physical grotto;
        // deeper subregions inherit the gate from their entrance.
        case RR_COLOSSUS_GROTTO:
        case RR_DMC_POT_GROTTO_ENTRY:
        case RR_DMC_ROCKS_GROTTO_ENTRY:
        case RR_DMC_ROCK_GROTTO:
        case RR_DMC_SCRUB_GROTTO:
        case RR_DMC_UPPER_GROTTO:
        case RR_DMT_COW_GROTTO:
        case RR_DMT_STORMS_GROTTO:
        case RR_GC_GROTTO:
        case RR_GF_STORMS_GROTTO:
        case RR_GV_OCTOROK_GROTTO:
        case RR_GV_STORMS_GROTTO:
        case RR_HC_STORMS_GROTTO:
        case RR_HF_COW_GROTTO:
        case RR_HF_FAIRY_GROTTO:
        case RR_HF_INSIDE_FENCE_GROTTO:
        case RR_HF_NEAR_KAK_GROTTO:
        case RR_HF_NEAR_MARKET_GROTTO:
        case RR_HF_OPEN_GROTTO:
        case RR_HF_SOUTHEAST_GROTTO:
        case RR_HF_TEKTITE_GROTTO:
        case RR_KAK_OPEN_GROTTO:
        case RR_KAK_REDEAD_GROTTO:
        case RR_KF_STORMS_GROTTO:
        case RR_LH_GROTTO:
        case RR_LLR_GROTTO:
        case RR_LW_NEAR_SHORTCUTS_GROTTO:
        case RR_LW_SCRUBS_GROTTO:
        case RR_SFM_FAIRY_GROTTO:
        case RR_SFM_STORMS_GROTTO:
        case RR_SFM_WOLFOS_GROTTO:
        case RR_ZD_STORMS_GROTTO:
        case RR_ZR_FAIRY_GROTTO:
        case RR_ZR_OPEN_GROTTO:
        case RR_ZR_STORMS_GROTTO:
            return true;
        default:
            return false;
    }
...
bool Entrance::GetConditionsMet() const {
    ...
    if (ctx->GetOption(RSK_LOGIC_RULES).Is(RO_LOGIC_GLITCHLESS)) {
        // Gate the physical/source grotto even after entrance randomization.
        // originalConnectedRegion remains the source's vanilla destination.
        if (ctx->GetOption(RSK_SHUFFLE_SHOVEL) && MegaIsShovelGrotto(originalConnectedRegion) &&
            !logic->HasItem(RG_SHOVEL)) {
            return false;
        }
