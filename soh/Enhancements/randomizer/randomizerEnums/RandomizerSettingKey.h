...
RANDO_ENUM_ITEM(RSK_STARTING_MEGATON_HAMMER)
RANDO_ENUM_ITEM(RSK_STARTING_BOOMERANG)
RANDO_ENUM_ITEM(RSK_STARTING_LENS_OF_TRUTH)
RANDO_ENUM_ITEM(RSK_STARTING_DINS_FIRE)
RANDO_ENUM_ITEM(RSK_STARTING_FARORES_WIND)
RANDO_ENUM_ITEM(RSK_STARTING_NAYRUS_LOVE)
RANDO_ENUM_ITEM(RSK_STARTING_FIRE_ARROWS)
RANDO_ENUM_ITEM(RSK_STARTING_ICE_ARROWS)
RANDO_ENUM_ITEM(RSK_STARTING_LIGHT_ARROWS)
RANDO_ENUM_ITEM(RSK_STARTING_IRON_BOOTS)
RANDO_ENUM_ITEM(RSK_STARTING_HOVER_BOOTS)
RANDO_ENUM_ITEM(RSK_STARTING_HYLIAN_SHIELD)
RANDO_ENUM_ITEM(RSK_STARTING_MIRROR_SHIELD)
RANDO_ENUM_ITEM(RSK_STARTING_GORON_TUNIC)
RANDO_ENUM_ITEM(RSK_STARTING_ZORA_TUNIC)
RANDO_ENUM_ITEM(RSK_STARTING_STONE_OF_AGONY)
RANDO_ENUM_ITEM(RSK_STARTING_HOOKSHOT)
RANDO_ENUM_ITEM(RSK_STARTING_BOW)
RANDO_ENUM_ITEM(RSK_STARTING_SLINGSHOT)
RANDO_ENUM_ITEM(RSK_STARTING_BOMB_BAG)
RANDO_ENUM_ITEM(RSK_STARTING_STRENGTH)
RANDO_ENUM_ITEM(RSK_STARTING_SCALE)
RANDO_ENUM_ITEM(RSK_STARTING_WALLET)
RANDO_ENUM_ITEM(RSK_STARTING_MAGIC_METER)
RANDO_ENUM_ITEM(RSK_STARTING_BOMBCHU_BAG)
RANDO_ENUM_ITEM(RSK_STARTING_BOTTLE_1)
RANDO_ENUM_ITEM(RSK_STARTING_BOTTLE_2)
RANDO_ENUM_ITEM(RSK_STARTING_BOTTLE_3)
RANDO_ENUM_ITEM(RSK_STARTING_BOTTLE_4)
RANDO_ENUM_ITEM(RSK_STARTING_WEIRD_EGG)
RANDO_ENUM_ITEM(RSK_STARTING_ZELDAS_LETTER)
RANDO_ENUM_ITEM(RSK_STARTING_CLAIM_CHECK)
RANDO_ENUM_ITEM(RSK_STARTING_GERUDO_CARD)
RANDO_ENUM_ITEM(RSK_STARTING_BIGGORON_SWORD)
...
RANDO_ENUM_ITEM(RSK_SHUFFLE_MASKS)
...
RANDO_ENUM_ITEM(RSK_BUNNY_HOOD)
RANDO_ENUM_ITEM(RSK_MASKS_AS_ADULT)
...
RANDO_ENUM_ITEM(RSK_KEYRINGS_CHEST_GAME)
...
// Mega Randomizer - real SoH-integrated progression abilities/souls
RANDO_ENUM_ITEM(RSK_SHUFFLE_ROLL)
RANDO_ENUM_ITEM(RSK_SHUFFLE_ENEMY_SOUL)
RANDO_ENUM_ITEM(RSK_SHUFFLE_NPC_SOUL)
RANDO_ENUM_ITEM(RSK_SHUFFLE_ANIMAL_SOUL)
RANDO_ENUM_ITEM(RSK_SHUFFLE_POT_SOUL)
RANDO_ENUM_ITEM(RSK_SHUFFLE_CRATE_SOUL)
RANDO_ENUM_ITEM(RSK_SHUFFLE_GRASS_SOUL)
RANDO_ENUM_ITEM(RSK_SHUFFLE_ROCK_SOUL)
RANDO_ENUM_ITEM(RSK_SHUFFLE_TREE_SOUL)
RANDO_ENUM_ITEM(RSK_SHUFFLE_BEEHIVE_SOUL)
RANDO_ENUM_ITEM(RSK_SHUFFLE_SIGN_SOUL)
RANDO_ENUM_ITEM(RSK_SHUFFLE_SKULLTULA_SOUL)
RANDO_ENUM_ITEM(RSK_SHUFFLE_SHOVEL)
RANDO_ENUM_ITEM(RSK_SHUFFLE_BUSINESS_SCRUB_SOUL)
RANDO_ENUM_ITEM(RSK_NPC_SPEECH_SANITY)
RANDO_ENUM_ITEM(RSK_SONG_NOTE_SHUFFLE)
RANDO_ENUM_ITEM(RSK_SHUFFLE_FLOW_OF_TIME)
RANDO_ENUM_ITEM(RSK_FROZEN_STARTING_TIME)
RANDO_ENUM_ITEM(RSK_TIME_SPEED_AFTER_UNLOCK)
RANDO_ENUM_ITEM(RSK_EXTREME_TRAP_POOL)
RANDO_ENUM_ITEM(RSK_EXTREME_ICE_TRAPS)
RANDO_ENUM_ITEM(RSK_EXTREME_FIRE_TRAPS)
RANDO_ENUM_ITEM(RSK_EXTREME_SLOW_TRAPS)
RANDO_ENUM_ITEM(RSK_EXTREME_MAGIC_SUCK_TRAPS)
RANDO_ENUM_ITEM(RSK_EXTREME_HEALTH_DRAIN_TRAPS)
RANDO_ENUM_ITEM(RSK_EXTREME_TRAP_PERCENT)
RANDO_ENUM_ITEM(RSK_SHUFFLE_ENEMY_DROPS)
...
RANDO_ENUM_ITEM(RSK_SHUFFLE_WONDER_ITEMS)
RANDO_ENUM_ITEM(RSK_SHUFFLE_SILVER)
...
RANDO_ENUM_ITEM(RSK_STARTING_KEATON_MASK)
RANDO_ENUM_ITEM(RSK_STARTING_SKULL_MASK)
RANDO_ENUM_ITEM(RSK_STARTING_SPOOKY_MASK)
RANDO_ENUM_ITEM(RSK_STARTING_BUNNY_HOOD)
RANDO_ENUM_ITEM(RSK_STARTING_GORON_MASK)
RANDO_ENUM_ITEM(RSK_STARTING_ZORA_MASK)
RANDO_ENUM_ITEM(RSK_STARTING_GERUDO_MASK)
RANDO_ENUM_ITEM(RSK_STARTING_MASK_OF_TRUTH)
