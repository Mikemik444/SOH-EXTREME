...
RANDO_ENUM_ITEM(RG_SHADOW_SILVER_BLADES)
RANDO_ENUM_ITEM(RG_SHADOW_SILVER_PIT)
RANDO_ENUM_ITEM(RG_SHADOW_SILVER_SPIKES)
RANDO_ENUM_ITEM(RG_SPIRIT_SILVER_CHILD)
RANDO_ENUM_ITEM(RG_SPIRIT_SILVER_SUN)
RANDO_ENUM_ITEM(RG_SPIRIT_SILVER_BOULDERS)
RANDO_ENUM_ITEM(RG_BOTW_SILVER)
RANDO_ENUM_ITEM(RG_ICE_CAVERN_SILVER_BLADES)
RANDO_ENUM_ITEM(RG_ICE_CAVERN_SILVER_BLOCK)
RANDO_ENUM_ITEM(RG_GTG_SILVER_SLOPE)
RANDO_ENUM_ITEM(RG_GTG_SILVER_LAVA)
RANDO_ENUM_ITEM(RG_GTG_SILVER_WATER)
RANDO_ENUM_ITEM(RG_GANONS_CASTLE_SILVER_LIGHT)
RANDO_ENUM_ITEM(RG_GANONS_CASTLE_SILVER_FOREST)
RANDO_ENUM_ITEM(RG_GANONS_CASTLE_SILVER_FIRE)
RANDO_ENUM_ITEM(RG_GANONS_CASTLE_SILVER_SPIRIT)
RANDO_ENUM_ITEM(RG_DODONGOS_CAVERN_MQ_SILVER)
RANDO_ENUM_ITEM(RG_SHADOW_MQ_SILVER_INVISIBLE_BLADES)
RANDO_ENUM_ITEM(RG_SPIRIT_MQ_SILVER_LOBBY)
RANDO_ENUM_ITEM(RG_SPIRIT_MQ_SILVER_BIG_WALL)
RANDO_ENUM_ITEM(RG_GANONS_CASTLE_MQ_SILVER_WATER)
RANDO_ENUM_ITEM(RG_GANONS_CASTLE_MQ_SILVER_SHADOW)
...
// Mega Randomizer progression items
RANDO_ENUM_ITEM(RG_ROLL)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL)
RANDO_ENUM_ITEM(RG_NPC_SOUL)
RANDO_ENUM_ITEM(RG_ANIMAL_SOUL)
RANDO_ENUM_ITEM(RG_POT_SOUL)
RANDO_ENUM_ITEM(RG_CRATE_SOUL)
RANDO_ENUM_ITEM(RG_GRASS_SOUL)
RANDO_ENUM_ITEM(RG_ROCK_SOUL)
RANDO_ENUM_ITEM(RG_TREE_SOUL)
RANDO_ENUM_ITEM(RG_BEEHIVE_SOUL)
RANDO_ENUM_ITEM(RG_SIGN_SOUL)
RANDO_ENUM_ITEM(RG_SKULLTULA_SOUL)
RANDO_ENUM_ITEM(RG_SHOVEL)
RANDO_ENUM_ITEM(RG_BUSINESS_SCRUB_SOUL)
RANDO_ENUM_ITEM(RG_FLOW_OF_TIME)

// Custom Items
RANDO_ENUM_ITEM(RG_ROCS_FEATHER)

// Archipelago cosmetic-only remote item placeholders
RANDO_ENUM_ITEM(RG_AP_REMOTE_IMPORTANT)
RANDO_ENUM_ITEM(RG_AP_REMOTE_NORMAL)
