...
void RegionTable_Init_LostWoods() {
    ...
    areaTable[RR_LW_BEYOND_MIDO] = Region("LW Beyond Mido", SCENE_LOST_WOODS, {
        ...
        LOCATION(RC_LW_BOULDER_RUPEE,                      (!ctx->GetOption(RSK_SHUFFLE_ROCK_SOUL) || logic->HasItem(RG_ROCK_SOUL)) && logic->BlastOrSmash()),
    ...
    areaTable[RR_LW_BRIDGE] = Region("LW Bridge", SCENE_LOST_WOODS, {}, {}, {
        ...
        // SOH-EXTREME 0.7.55: Closed Forest is a hard physical barrier.
