...
void RegionTable_Init_HyruleField() {
    ...
    areaTable[RR_HYRULE_FIELD] = Region("Hyrule Field", SCENE_HYRULE_FIELD, {
        ...
        LOCATION(RC_HF_ROCK_1,                     logic->CanBreakRocks()),
        LOCATION(RC_HF_ROCK_2,                     logic->CanBreakRocks()),
        LOCATION(RC_HF_ROCK_3,                     logic->CanBreakRocks()),
        LOCATION(RC_HF_ROCK_4,                     logic->CanBreakRocks()),
        LOCATION(RC_HF_ROCK_5,                     logic->CanBreakRocks()),
        LOCATION(RC_HF_ROCK_6,                     logic->CanBreakRocks()),
        LOCATION(RC_HF_ROCK_7,                     logic->CanBreakRocks()),
        LOCATION(RC_HF_ROCK_8,                     logic->CanBreakRocks()),
    ...
    areaTable[RR_HF_COW_GROTTO_BEHIND_WEBS] = Region("HF Cow Grotto Behind Webs", SCENE_GROTTOS, {
        ...
        LOCATION(RC_HF_COW_GROTTO_COW, (!ctx->GetOption(RSK_SHUFFLE_ANIMAL_SOUL) || logic->HasItem(RG_ANIMAL_SOUL)) &&                    logic->CanUse(RG_EPONAS_SONG)),
