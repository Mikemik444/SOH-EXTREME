...
echo ============================================================
echo SOH-EXTREME 0.7.45 - NATIVE AP SETTINGS / SOUL FIX
echo ============================================================
echo.
...
echo APWorld: soh_extreme_0.7.45.apworld
echo 0.7.45 refreshes Ship's complete native IS_RANDO hook path after
