...
echo ============================================================
echo SOH-EXTREME 0.7.55 - ENEMY DROPS + PROGRESSION LOGIC FIX
echo ============================================================
echo.
...
echo APWorld: soh_extreme_0.7.55.apworld
echo 0.7.55 adds enemy drops, correct Grab/Strength progression, grass logic, and keeps the death-safe AP queue.
