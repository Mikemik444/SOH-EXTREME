...
echo ============================================================
echo SOH-EXTREME 0.7.44 - NATIVE AP SETTINGS / SOUL FIX
echo ============================================================
echo.
...
echo APWorld: soh_extreme_0.7.44.apworld
echo 0.7.44 refreshes Ship's complete native IS_RANDO hook path after
